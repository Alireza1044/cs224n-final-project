...
def naiveSoftmaxLossAndGradient(
    ...
    """ Naive Softmax loss & gradient function for 1.word2vec models

    Implement the naive softmax loss and gradients between a center word's 
    embedding and an outside word's embedding. This will be the building block
    for our 1.word2vec models. For those unfamiliar with numpy notation, note
...
def negSamplingLossAndGradient(
    ...
    """ Negative sampling loss function for 1.word2vec models

    Implement the negative sampling loss and gradients for a centerWordVec
    and a outsideWordIdx word vector as a building block for 1.word2vec
...
def test_word2vec():
    """ Test the two 1.word2vec implementations, before running on Stanford Sentiment Treebank """
    test_sigmoid()
