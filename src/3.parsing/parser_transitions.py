...
class PartialParse(object):
    ...
    def parse_step(self, transition):
        ...
        ### TODO:
        ###     Implement a single 3.parsing step, i.e. the logic for the following as
    ...
    def parse(self, transitions):
        ...
        @return dependencies (list of string tuples): The list of dependencies produced when
                                                        3.parsing the sentence. Represented as a list of
                                                        tuples where each tuple is of the form (head, dependent).
        """
...
def minibatch_parse(sentences, model, batch_size):
    ...
    @param model (ParserModel): The model that makes 3.parsing decisions. It is assumed to have a function
